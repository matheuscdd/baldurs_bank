...
public class DisableManagerAccountHandler : IRequestHandler<DisableManagerAccountCommand>
{
    private readonly IAccountRepository  _accountRepository;

    public DisableManagerAccountHandler(IAccountRepository accountRepository)
    {
        _accountRepository = accountRepository;
    }

    public async Task Handle(
        DisableManagerAccountCommand request,
