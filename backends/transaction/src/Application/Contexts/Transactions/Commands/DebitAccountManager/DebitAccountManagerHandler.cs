...
public class DebitAccountManagerHandler : IRequestHandler<DebitAccountManagerCommand, TransactionDto>
{
    private readonly ITransactionRepository  _transactionRepository;

    public DebitAccountManagerHandler(ITransactionRepository transactionRepository)
    {
        _transactionRepository = transactionRepository;
    }

    public async Task<TransactionDto> Handle(DebitAccountManagerCommand request, CancellationToken cancellationToken)
    {
